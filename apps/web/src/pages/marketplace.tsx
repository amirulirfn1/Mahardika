...
const mockProducts = [
  {
    ...
    description:
      'Comprehensive coverage for small to medium businesses with liability, property, and cyber protection.',
    price: 299,
    originalPrice: 399,
    currency: 'USD',
  ...
  },
  {
    ...
    description:
      'Complete family protection with health, life, and disability insurance at an affordable rate.',
    price: 189,
    originalPrice: 249,
    currency: 'USD',
  ...
  },
  {
    ...
    description:
      'Enhanced auto coverage with roadside assistance, rental car, and comprehensive collision protection.',
    price: 129,
    originalPrice: 159,
    currency: 'USD',
  ...
  },
  {
    ...
    description:
      'Complete home insurance with natural disaster coverage, personal property, and liability protection.',
    price: 219,
    originalPrice: 279,
    currency: 'USD',
  ...
  },
  {
    ...
    description:
      'Specialized protection for professionals and consultants against claims and legal disputes.',
    price: 179,
    originalPrice: 229,
    currency: 'USD',
  ...
  },
  {
    ...
    description:
      'Comprehensive travel protection with medical, trip cancellation, and emergency evacuation coverage.',
    price: 89,
    originalPrice: 119,
    currency: 'USD',
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                >
                  ...
                  Compare features, prices, and reviews to find your perfect
                  coverage.
                </p>
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <h2 className="h3 fw-bold mb-3">Need Help Choosing?</h2>
                <p className="mb-4" style={{ fontSize: '18px', opacity: 0.9 }}>
                  Our insurance experts can help you compare products and find
