...
const DATA_TYPES = [
  ...
  },
  {
    ...
    description: 'Policy details, documents, claims',
  },
  {
    id: 'payments',
    label: 'Payment Information',
    description: 'Transaction history, payment methods, billing',
  },
  {
    id: 'communications',
    label: 'Communications',
    description: 'Emails, messages, support tickets, call logs',
  },
  {
    id: 'analytics',
    label: 'Usage Analytics',
    description: 'Site usage, behavior data, preferences',
  },
  {
    id: 'documents',
    label: 'Uploaded Documents',
    description: 'Files, attachments, identity verification',
  },
  {
    id: 'consent',
    label: 'Consent Records',
    description: 'Cookie consents, privacy preferences, opt-ins',
  },
  {
    id: 'other',
    label: 'Other Data',
    description: 'Any other personal information we may hold',
  },
];
...
const REQUEST_TYPE_INFO = {
  export: {
    ...
    timeline: '30 days',
    details:
      'We will compile all your personal data into a downloadable file format (typically JSON or CSV). This includes all data types you select below.',
  },
  delete: {
    title: 'Data Deletion',
    ...
    timeline: '30 days',
    details:
      'We will permanently delete the selected data types from our systems. Note: Some data may be retained for legal compliance purposes.',
  },
  rectify: {
    ...
    timeline: '30 days',
    details:
      'We will review and correct any inaccurate personal information. Please provide details about what needs to be corrected in the description field.',
  },
};
...
export default function DataSubjectRightsPage() {
  ...
  const validateForm = useCallback((): boolean => {
    ...
    if (
      (formData.type === 'rectify' || formData.type === 'delete') &&
      !formData.description.trim()
    ) {
      errors.description =
        formData.type === 'rectify'
    ...
    if (formData.verificationDocument) {
      if (!ACCEPTED_FILE_TYPES.includes(formData.verificationDocument.type)) {
        errors.verificationDocument =
          'File type not supported. Please upload JPG, PNG, GIF, WebP, or PDF files only.';
    ...
    >
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          >
            Exercise your rights under GDPR, CCPA, and other privacy
            regulations.
          </p>
        ...
        {submitStatus === 'success' && showEmailVerification && (
          ...
          >
            ...
            <p style={{ margin: 0 }}>
              We&apos;ve sent a confirmation email to verify your identity.
        ...
        >
          ...
          <div>
            <label style={labelStyles}>Type of Request *</label>
              ...
              {Object.entries(REQUEST_TYPE_INFO).map(([value, info]) => (
                <div
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    backgroundColor:
                      formData.type === value ? colors.gray[50] : 'transparent',
                    transition: 'all 0.2s',
                  }}
                  onClick={() =>
                    setFormData(prev => ({
          ...
          >
            <div>
              ...
              <input
                ...
                style={
                  validationErrors.fullName ? inputErrorStyles : inputStyles
                }
            ...
            <div>
              <label style={labelStyles}>Confirm Email Address *</label>
              <input
                type="email"
                ...
                style={
                  validationErrors.confirmEmail ? inputErrorStyles : inputStyles
                }
            ...
            <div>
              <label style={labelStyles}>Request Urgency</label>
              <select
          ...
          {/* Data Types */}
          <div>
            <label style={labelStyles}>Data Types to Include *</label>
            <p
              style={{
                fontSize: '0.875rem',
                color: colors.gray[600],
              ...
              {DATA_TYPES.map(dataType => (
                <label
                  ...
                  style={{
                    ...
                    borderRadius: '0.5rem',
                    cursor: 'pointer',
                    backgroundColor: formData.dataTypes.includes(dataType.id)
                      ? colors.gray[50]
                      : 'transparent',
                    transition: 'all 0.2s',
                  }}
                  ...
                  <input
                    ...
                    onChange={e => {
                      if (e.target.checked) {
                        ...
                        setFormData(prev => ({
                          ...prev,
                          dataTypes: prev.dataTypes.filter(
                            id => id !== dataType.id
                          ),
                        }));
                      }
          ...
          <div>
            ...
            >
              Upload a document to verify your identity (driver&apos;s license,
              passport, etc.). This helps us process your request faster.
            </p>
          ...
          <div>
            ...
            >
              ...
              <span style={{ color: colors.gray[700] }}>
                ...
                am the data subject or have been authorized to act on behalf of
                the data subject. I understand that providing false information
                may delay or prevent processing of this request. *
              </span>
            </label>
          ...
          <div style={{ textAlign: 'center', paddingTop: '1rem' }}>
            ...
            >
              {isSubmitting
                ? '🔄 Submitting...'
                : `🚀 Submit ${REQUEST_TYPE_INFO[formData.type].title} Request`}
            </button>
            ...
            >
              ...
              and understand that we will contact you at the provided email
              address to verify your identity and process your request.
            </p>
          </div>
        </form>
      </div>
