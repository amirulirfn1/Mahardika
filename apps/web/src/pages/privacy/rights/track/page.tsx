...
export default function DSRTrackingPage() {
  ...
  const handleTrackRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'An error occurred while tracking your request');
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div style={{
        ...
        {showRequestForm && (
          <div style={{
            ...
            <form onSubmit={handleTrackRequest} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div>
                ...
                <input
                  ...
                  required
                />
                <p style={{ fontSize: '0.75rem', color: colors.gray[600], marginTop: '0.25rem' }}>
