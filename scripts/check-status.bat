...
if exist "apps\admin-web\.env.local" (
    echo ✅ Environment file exists
) else (
    echo ❌ Create apps/admin-web/.env.local with Supabase credentials
)
...
echo.
echo Next steps:
echo 1. Configure environment variables in apps/admin-web/.env.local
